...
(function () {
  ...
  var KNOWLEDGE = [
    ...
    { rx: /bracket|multiplier|provider cost|3x|10x|double/i,
      a: 'ACU prices are provider cost × a margin band set by your capital bracket: ≤£10k is 3–10× (the standard price list). Every £10k above doubles the band — £10k–£20k is 6–20× (×2 prices), £20k–£30k is 12–40× (×4), and so on.',
      s: 'Move the capital slider in the Search Canvas — your bracket and every price update live before you commit.' },
