...
const VERSION = 'nf-v20';
const SHELL = [
  'index.html', 'search.html', 'project.html', 'dashboard.html', 'asset.html',
  'growth.html', 'settings.html', 'account.html',
  'nf-config.js', 'nf-auth.js', 'nf-wallet.js', 'nf-support.js', 'nf-consent.js', 'nf-install.js', 'nf-tags.js',
  'nf-xlsx.js', 'nf-docx.js', 'nf-tags.js',
  ...
  // by the OS at install time and served network-first here — not precached (8MB+).
